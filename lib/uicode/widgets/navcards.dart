...
import 'package:ezapplyadmin/uicode/widgets/viewmore.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

import '../../code/managers/services_manager.dart';
import '../../code/models/mapable/application_data.dart';
import '../../code/models/mapable/news_data.dart';
import '../pages/viewApplication.dart';
            ...
            children: [
              Consumer<NewsManager>(
                builder: (context, value, child) => IconButton(
                    onPressed: (() async {
                      await value.deletenews(
                          url: newsModel.banner, reff: newsModel.reff!);
                    }),
                    // manager.deletenews,
                    icon: const Icon(
                      Icons.delete,
